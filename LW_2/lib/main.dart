...
class _MainScreenState extends State<MainScreen> {
  String _selectedFuel = 'Вугілля';
  final List<String> _fuelTypes = ['Вугілля', 'Мазут', 'Природній газ'];
